...
<nav class="shadow navbar navbar-expand-lg navbar-dark fixed-top h-21" style="background-image:linear-gradient(to bottom, #a6e9af,#7cc4ee) !important;">
    ...
    <div style="margin-top: 75px" class="container">
      <?php
        include "connect.php";
        $sql = "SELECT stdcount FROM yestreport ";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
          $row = mysqli_fetch_assoc($result);
          echo "<p class='text-success font-weight-bold'>No. of students responsed :  <span style='font-size:24px' class='text-primary font-weight-bold '>" . $row['stdcount'] . "</span></p>";
							...
							<div class="modal-body text-center">
								<div id="student">
									...
									<div class="d-flex flex-row justify-content-center">
										...
										<form action="yestreport.php" method="post">
